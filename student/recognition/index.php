...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css"
        integrity="sha512-iecdLmaskl7CVkqkXNQ/ZmCULaM6tU8zTtIk2+3zV9zzTtmI3UksdQRVvoxMfooAo0vw5qXhPYnFOnJ0"
...
<body>
    <div class="container">
        ...
        WHERE admissionNo = ?");
                        $stmt->bind_param("s", $studentId);
                        if ($stmt->execute()) {
                            echo "<div class='result text-green-700 font-semibold'>✅ Attendance marked successfully</div>";
