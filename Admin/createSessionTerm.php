            ...
            <div class="col-lg-12">
                  ...
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                            ...
                            <input type="text" name="semesterName" class="form-control" placeholder="Enter Semester Name" value="<?php if(isset($row['semesterName'])){echo $row['semesterName'];}?>" required>
                              <!-- <?php
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <h6 class="m-0 font-weight-bold text-danger">Note: <i>Click on the check symbol besides a semester to activate!</i></h6>
                </div>
