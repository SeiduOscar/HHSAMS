...
@media (max-width: 768px) {
    ...
    /* Fix sidebar overlay white layer */
/* .sidebar-overlay {
                                    ...
                                    <form method="post">
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-12 col-md-6 col-xl-6">
                                                ...
                                                <input type="password" class="form-control" required name="password"
                                                    value="<?php echo $row['password'] ?>" id="inputPassword">
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-12 col-md-6 col-xl-6">
                                                ...
                                                <input type="email" class="form-control" required name="emailAddress"
                                                    value="<?php echo $row['emailAddress']; ?>" id="inputEmailAddress"
                                            ...
                                            <div class="col-12 col-md-6 col-xl-6">
                                                ...
                                                <input type="text" class="form-control" name="phoneNo"
                                                    value="<?php echo $row['phoneNo']; ?>" id="inputPhoneNo">
                                            </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            <div class="col-12 col-xl-6">
                                                <label class="form-control-label">Faculty<span
                                                        class="text-danger ml-2">*</span></label>
