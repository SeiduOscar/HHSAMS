          ...
          <div class="row">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="courseCode" value="<?php echo isset($course['courseCode']) ? $course['courseCode'] : ''; ?>" required>
              </div>
              <div class="form-group">
                  <label>Course Name</label>
                  <input type="text" class="form-control" name="courseName" value="<?php echo isset($course['courseName']) ? $course['courseName'] : ''; ?>" required>
              </div>
              <div class="form-group">
                  <label>Select Level</label>
                  <select name="level" class="form-control" required>
                  <option value="">--Select Class--</option>
                  <option value="100" <?php if(isset($course['Level']) && $course['Level'] == 100) echo 'selected'; ?>>LEVEL 100</option>
                  <option value="200" <?php if(isset($course['Level']) && $course['Level'] == 200) echo 'selected'; ?>>LEVEL 200</option>
                  <option value="300" <?php if(isset($course['Level']) && $course['Level'] == 300) echo 'selected'; ?>>LEVEL 300</option>
                  <option value="400" <?php if(isset($course['Level']) && $course['Level'] == 400) echo 'selected'; ?>>LEVEL 400</option>
                  </select>
              </div>
              <div class="form-group">
                  <label>Program</label>
              ...
              <div class="form-group">
                  ...
                  <option value="1" <?php if(isset($course['general']) && $course['general'] == 1) echo 'selected'; ?>>1</option>
                  <option value="0" <?php if(isset($course['general']) && $course['general'] == 0) echo 'selected'; ?>>0</option>
                  </select>
              </div>
              <div class="form-group">
                  ...
                  <option value="1" <?php if(isset($course['semester']) && $course['semester'] == 1) echo 'selected'; ?>>1</option>
                  <option value="2" <?php if(isset($course['semester']) && $course['semester'] == 2) echo 'selected'; ?>>2</option>
                  </select>
              </div>
              <div class="form-group row mb-3">
                  <div class="col-xl-12">
                  <label class="form-control-label">Select Lecturers<span class="text-danger ml-2">*</span></label>
