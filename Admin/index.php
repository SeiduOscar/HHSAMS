...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['addAdmin'])) {
    ...
    $emailValid = preg_match('/^[a-zA-Z0-9._%+-]+@(hcuc\.edu\.gh|hcu\.edu\.gh)$/i', $emailAddress);
    if (!$emailValid) {
        $adminMsg = "<div class='alert alert-danger'>Invalid email domain. Email must end with @hcuc.edu.gh or @hcu.edu.gh.</div>";
    } else {
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $students; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100 border-left-success">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">No.
                                                Admins</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $admins; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100 border-left-success">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Class
                                                Arms</div>
                                    ...
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Active Semester</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php echo $sessTerm['semesterName'] ?? 'N/A'; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100 border-left-info">
                                <div class="card-body">
                                    <div class="row align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">No.
                                                Semesters</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $termonly; ?>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card shadow h-100 border-left-primary">
                                <div class="card-body d-flex flex-column justify-content-center align-items-center">
                                    ...
                                    <div class="text-xs font-weight-bold text-uppercase mb-1">Admin User Management
                                    </div>
                                    <button class="btn btn-success btn-sm mt-2 mb-1" data-toggle="modal"
                                        data-target="#addAdminModal">Add
                                        Admin User</button>
                                    <button class="btn btn-info btn-sm mb-1" data-toggle="modal"
                                        data-target="#editAdminModal">Edit Admin
                                        Users</button>
                                </div>
                            </div>
                        </div>
                  ...
                  <form method="post" action="./deleteAdmin.php" style="display:inline;" onsubmit="return confirm(&quot;Are you sure you want to delete this admin user?&quot;);">
                    ...
                    <button type="submit" class="btn btn-sm btn-danger">Delete</button>
                      ...
                      <div class="form-row">
                        ...
                        <input type="email" class="form-control" name="emailAddress" value="` + emailAddress + `" pattern="^[a-zA-Z0-9._%+-]+@(hcuc\.edu\.gh|hcu\.edu\.gh)$" required>
                        </div>
                        <div class="form-group col-md-6">
