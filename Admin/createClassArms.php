...
if (isset($_POST['save'])) {
  ...
  if ($ret > 0) {
    ...
    $query = mysqli_query($conn, "insert into tblclassarms(classArmName,isAssigned) value('$classArmName','0')");
...
if (isset($_GET['Id']) && isset($_GET['action']) && $_GET['action'] == "edit") {
  ...
  if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($conn, "update tblclassarms set classArmName='$classArmName' where Id='$Id'");
                                        ...
                                        <div class="table-responsive p-3">
                                            <table class="table align-items-center table-flush table-hover"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                          $query = "SELECT tblclassarms.Id,tblclassarms.isAssigned,tblclassarms.classArmName 
                      FROM tblclassarms";
                          $rs = $conn->query($query);
                          $num = $rs->num_rows;
                          $sn = 0;
